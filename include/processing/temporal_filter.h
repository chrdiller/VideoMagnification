...
namespace temporal_filter {
    void ideal_filter(parameter_store& params, DataContainer& data_container);
    void iir_filter(parameter_store& params, DataContainer& data_container);
}
